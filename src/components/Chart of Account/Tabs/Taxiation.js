...
const Tabs = ({ setCounter, setgetnamefromchild, seteditglaccountfield, seteditglaccountfield2, setDbLevel, tree, setName, setActive,
  setupd, setdispupd, setGetFromTab8, tab8Name, setSearchNumber, setName1, setShowDropDown1, setShowDropDown2, assetChildUpdate, Group_Mask_Func8 }) => {
  ...
  const getheadername = () => {
    ...
    var config = {
      method: 'get',
      url: 'http://localhost:3331/chartOfAccount/80000000',
      headers: {
    ...
    axios(config)
      .then(function (response) {
        ...
        setGetFromTab8(response.data.Name)
