...
const Tabs = ({ setCounter, setgetnamefromchild, seteditglaccountfield, seteditglaccountfield2, setDbLevel, tree, setName, setActive,
  setupd, setdispupd, setGetFromTab7, tab7Name, setSearchNumber, setName1, setShowDropDown1, setShowDropDown2, assetChildUpdate, Group_Mask_Func7 }) => {
  ...
  const getheadername = () => {
    ...
    var config = {
      method: 'get',
      url: 'http://localhost:3331/chartOfAccount/70000000',
      headers: {
    ...
    axios(config)
      .then(function (response) {
        ...
        setGetFromTab7(response.data.Name)
