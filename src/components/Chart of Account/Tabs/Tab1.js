...
import { TreeView, Style, } from '@material-ui/lab';
import { TreeItem } from '@material-ui/lab';
import ExpandMoreIcon from "@material-ui/icons/ExpandMore";
import ChevronRightIcon from "@material-ui/icons/ChevronRight";
const Tabs = ({ 
  setCounter, setgetnamefromchild,Group_Mask_Func,
  seteditglaccountfield, seteditglaccountfield2, 
  setName1, setShowDropDown1, setShowDropDown2, 
  setName, setActive, tree,setupd, setdispupd,
  setGetFromTab1, tabName, setSearchNumber,   
  }) => {
  ...
  const getheadername = () => {
    ...
    var config = {
      method: 'get',
      url: 'http://localhost:3331/chartOfAccount/100000000',
      headers: {
    ...
    axios(config)
      .then(function (response) {
        ...
        setGetFromTab1(response.data.Name)
  ...
  const handleExpandClick = expandDefault => {
    setExpanded(() =>
      [
        ...
        "61e9636f29818df3f17bf0a8",
        "61e962db29818df3f17bf090"
      ]
    )
  };
