...
const Tabs = ({ setCounter, setgetnamefromchild, seteditglaccountfield, seteditglaccountfield2, setDbLevel, tree, setName, setActive,
  setupd, setdispupd, setGetFromTab3, tab3Name, setSearchNumber, setName1, setShowDropDown1, setShowDropDown2, assetChildUpdate, Group_Mask_Func3 }) => {
  ...
  const getheadername = () => {
    ...
    var config = {
      method: 'get',
      url: 'http://localhost:3331/chartOfAccount/30000000',
      headers: {
    ...
    axios(config)
      .then(function (response) {
        ...
        setGetFromTab3(response.data.Name)
