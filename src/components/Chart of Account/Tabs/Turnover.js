...
const Tabs = ({ setCounter, setgetnamefromchild, seteditglaccountfield, seteditglaccountfield2, setDbLevel, tree, setName, setActive,
  setupd, setdispupd, setGetFromTab4, tab4Name, setSearchNumber, setName1, setShowDropDown1, setShowDropDown2, assetChildUpdate, Group_Mask_Func4 }) => {
  ...
  const getheadername = () => {
    ...
    var config = {
      method: 'get',
      url: 'http://localhost:3331/chartOfAccount/40000000',
      headers: {
    ...
    axios(config)
      .then(function (response) {
        ...
        setGetFromTab4(response.data.Name)
