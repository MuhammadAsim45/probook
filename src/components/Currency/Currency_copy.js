...
// const Input = () => {
//   //useRef hooks return mutable return object whose .current property is initilized to passed argument ("").
...
//       Outgoing: Outgoing
//     }
//     //short hand axios to post data axios.post("url",data).then(res=>{console.log(res).catch(err){res.send(err)}})
//     axios.post("http://localhost:3331/currency_copy", newNote).then(res => {
//       console.log(res);
//       setError("")
...
//     var config = {
//       method: 'patch',
//       url: `http://localhost:3331/currency_copy/${SearchNumber}`,
//       headers: {
//         'Content-Type': 'application/json'
//       },
//       data: data
...
//     console.log(outgoing_Amt_Diff_Allowed);
//   }
...
//     var config = {
//       method: 'get',
//       url: 'http://localhost:3331/currency_copy',
//       // data: data,
//       // headers: {
//       //   'Content-Type': 'application/json'
//       // }
...
//   return (
//     <>
//       <div class="divCurrencycopy" style={{ outline: 'none', border: 'none' }}>
//         <div class="row">
...
//               </div>
//               <br />
//               <div class="bank_username"><a style={{ cursor: 'pointer' }} 
//                onClick={() => { Find_FilterFunc() }}
//                 // onclick={AllData}
...
//                       <tr>
//                         <td></td>
//                         <td><input type="number" required name="Code" placeholder="Code" className="Curr_user-input" 
//                         value={code || HeaderData && HeaderData.Code}
//                          onChange={Code_Func}
//                         //  ref={refcode} 
//                         ></input></td>
//                         <td><input type="text" required name="Currency" placeholder="Currency" className="Curr_user-input" 
//                          value={currency || HeaderData && HeaderData.Currency} 
//                          onChange={Currency_Func}
//                         //  ref={refcurrency}
//                         ></input></td>
//                         <td><input type="number" required="required" placeholder="International_Code" name="International_Code" className="Curr_user-input"
//                          value={internationalCode || HeaderData && HeaderData.International_Code} 
//                         onChange={International_Code_Func} 
//                         // ref={refintercode}  

//                          /></td>
//                         <td><input type="text" required name="International_Description" placeholder="International_Description" className="Curr_user-input"
//                          value={internationalDiscription || HeaderData && HeaderData.International_Description}
//                          onChange={International_Description_Func} 
//                         // ref={refinterdis}  

//                          /></td>
//                         <td><input type="text" required name="Hundredth_Name" placeholder="Hundredth_Name" className="Curr_user-input"  
//                          value={hundredthName || HeaderData && HeaderData.Hundredth_Name} 
//                         onChange={Hundredth_Name_Func} 
//                         // ref={refhundred}  

//                          /></td>
//                         <td><input type="text" required name="English" placeholder="English" className="Curr_user-input" 
//                         value={english || HeaderData && HeaderData.English} 
//                         onChange={English_Func} 
//                         // ref={refenglish} 
                        
//                         /></td>
//                         <td><input type="text" required name="English_Hundredth_Name" placeholder="English_Hundredth_Name" className="Curr_user-input" 
//                          value={english_Hundredth_Name || HeaderData && HeaderData.English_Hundredth_Name} 
//                         onChange={English_Hundredth_Name_Func} 
//                         // ref={refenghundred}  
...
//                               <select placeholder="Select" required="required" name="ISO_Currency_Code"
//                                value={ISO_Currency_Code || HeaderData && HeaderData.ISO_Currency_Code} 
//                               onChange={ISO_Currency_Code_Func} style={{ marginTop: '1rem' }} 
//                               // ref={refiso} 
//                                >
...
//                         <td><input type="number" required name="Incoming_Amt_Diff_Allowed" placeholder="Incoming_Amt_Diff_Allowed" 
//                           value={incoming_Amt_Diff_Allowed || HeaderData && HeaderData.Incoming_Amt_Diff_Allowed} 
//                           onChange={Incoming_Amt_Diff_Allowed_Func} 
//                           className="Curr_user-input" 
//                           // ref={refinamount}  

//                         ></input></td>
//                         <td><input type="number" required name="Outgoing_Amt_Diff_Allowed" placeholder="Outgoing_Amt_Diff_Allowed" 
//                         value={outgoing_Amt_Diff_Allowed || HeaderData && HeaderData.Outgoing_Amt_Diff_Allowed}
//                          onChange={Outgoing_Amt_Diff_Allowed_Func} 
//                         className="Curr_user-input"
//                         //  ref={refoutamount}  

//                         ></input></td>
//                         <td><input type="text" required name="Outcoming_Incoming_Percent" placeholder="Outcoming_Incoming_Percent" 
//                           value={outcoming_Incoming_Percent || HeaderData && HeaderData.Outcoming_Incoming_Percent} 
//                           onChange={Outcoming_Incoming_Percent_Func} 
//                           className="Curr_user-input"
//                           //  ref={refoutinper}  

//                           ></input></td>
//                         <td><input type="text" required name="Outgoing" placeholder="Outgoing" 
//                         value={Outgoing || HeaderData && HeaderData.Outgoing} 
//                         onChange={Outgoing_Func} 
//                         className="Curr_user-input" 
//                         // ref={refoutgoing}  
...
//                 <br />
//                 <br />
//                 <button style={{ float: 'left' }} className="DR-add-button" type='submit' onClick={()=>{handleSubmit()}}>Add
                  
//                   {/* {ButtonName} */}
//                   </button>
//                 <button className="DR-add-button" style={{ float: 'right' }} type='submit' onClick={()=>{updataData()}}>update</button>

//               {/* </Form> */}
//               {showdel ? <button class="DR-add-button" 
//                   onClick={() => { DeleteData() }}
//                   > Delete </button> : null}
//               <button className="DR-cancel-button" 
