...
//onChange function
 ...
 useEffect(() =>{
            ...
            <div className="NAME_main_class">
                <div className="NAME_field">
                    <img
                        ...
                        alt="show"
                    />
                    <h2 style={{ textAlign: 'center' }}><b> Names</b></h2>
                </div>
                {data &&(
             <Table  bordered>
                 <TableHead>
    ...
    {data.map((item,index) => (
          ...
          onChange={e=>{handleCode(e,index)}} className=" Di_user-input"  /></td>

            <td><input type="text" readOnly name="Name" defaultValue={item.Name} 
          onChange={e=>{handleName(e,index)}} className=" Di_user-input"  /></td>    
          
      <td><input type="text"  name="CustomName" defaultValue={item.CustomName} 
          onChange={e=>{handleCustom(e,index)}} className=" Di_user-input"  /> 
           </td>                      
          </tr>
                ...
                <br />
                <br />
                <button className="Name-add-button"  onClick={() => {Update_Dim1()}}>Update</button>
                <button className="Name-cancel-button">Cancel</button>
